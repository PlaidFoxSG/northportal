                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="text_outer">
                                        ...
                                        <input type="text" id="email" name="email" class="form-control" placeholder="Doe">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="text_outer">
                                        ...
                                        <input type="number" id="email" name="email" class="form-control" placeholder="000 000 0000">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="text_outer">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control" placeholder="208-123 Water Street, Vancouver, BC, VIM 3C9"> 
                                    </div>
                                </div>
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="text_outer">
                                        ...
                                        <input type="password" id="email" name="email" class="form-control" placeholder="xxxxxxx">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="text_outer">
                                        ...
                                        <input type="number" id="email" name="email" class="form-control" placeholder="0">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="text_outer">
                                        ...
                                        <input type="text" id="email" name="email" class="form-control" placeholder="Insert text here">
                                    </div>
                                </div>
